...
### 3.1.Libraries
In this project, the libraries OpenCV,  pandas, matploblib, seaborn, Pillow, io,  tqdm, NumPy, selenium, Spotipy, time, os, requests, AutoTokenizer, google.generativeai, SentenceTransformerand and scikit-learn were used.
...
“Life’s a continuous cycle, a fall and a rise, where perception shapes our freedom.”
...
“My life's one endless weekend, fueled by late nights and a wild heart.”
The model captures the tone and mood of the song, conveying the individual’s free-spirited, unplanned, and passionate lifestyle in a simple yet powerful way.
...
![](Images/3x3%20Mood%20Table.jpeg)
